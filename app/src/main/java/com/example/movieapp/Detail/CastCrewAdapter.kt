...
class CastCrewAdapter : RecyclerView.Adapter<CastCrewAdapter.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(item: CastCrewResponse.Cast) {
            binding.apply {
    ...
    private val differCallback = object : DiffUtil.ItemCallback<CastCrewResponse.Cast>() {
        override fun areItemsTheSame(oldItem: CastCrewResponse.Cast, newItem: CastCrewResponse.Cast): Boolean {
            return oldItem.id == newItem.id
        }

        override fun areContentsTheSame(oldItem: CastCrewResponse.Cast, newItem: CastCrewResponse.Cast): Boolean {
